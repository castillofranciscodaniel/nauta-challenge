...
class UserRepositoryImplTest {
    ...
    @Test
    fun `throws RepositoryException when findByEmail fails`() = runTest {
        // Arrange
        val email = "test@example.com"
        ...
        assertTrue(exception.message!!.contains("Error finding user by email"))
    }

    @Test
    fun `throws RepositoryException when existsByEmail fails`() = runTest {
        // Arrange
        val email = "test@example.com"
        ...
        assertTrue(exception.message!!.contains("Error checking if user exists"))
    }

    @Test
    fun `throws ModelNotSavedException when save fails`() = runTest {
        // Arrange
        val user = User(
            id = null,
            email = "test@example.com",
        ...
        assertTrue(exception.message!!.contains("Failed to save user"))
    }
}